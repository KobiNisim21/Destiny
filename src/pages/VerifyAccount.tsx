            ...
            <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border border-gray-100">
                ...
                {status === 'loading' && (
                    <div className="space-y-6 py-8">
                        ...
                        <h1 className="text-xl font-bold font-['Assistant']">מאמת את החשבון...</h1>
                    </div>
                )}
                ...
                {status === 'success' && (
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-2xl font-bold font-['Assistant'] text-gray-900">החשבון אומת בהצלחה!</h1>
                            <p className="text-gray-500 font-['Assistant']">
                                תודה שאומתת. כעת ניתן להתחבר לחשבון שלך. <br />
                                קוד קופון נשלח למייל שלך! 🎁
                            </p>
                        </div>
                    ...
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-500 font-['Assistant']">
                                ...
                                אנא פנה לתמיכה או נסה להירשם מחדש.
                            </p>
                        </div>
